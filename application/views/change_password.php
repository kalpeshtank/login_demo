<html>
    <head>
        ...
        <title>CI-DEMO|Chang password</title>
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="login-box-body">
                <form method="post" action="<?php echo base_url(); ?>login/check_change_password" autocomplete="off">
                    <?php if ($message != '') { ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4 pull-right">
                            <a class="btn btn-primary btn-block btn-flat" href="<?php echo base_url(); ?>">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
